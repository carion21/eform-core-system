/*
  ...
  - Added the required column `sessionUuid` to the `DataRow` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE `DataRow` ADD COLUMN `sessionUuid` VARCHAR(255) NOT NULL;
